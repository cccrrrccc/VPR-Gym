...
if __name__ == '__main__':
	...
	env = VprEnv_blk_type(inner_num = 0.1, port = '6000', seed = 1, arch = 'vtr_flow/arch/titan/stratixiv_arch.timing.xml', directory = 'example', benchmark = 'vtr_flow/benchmarks/titan_blif/stereo_vision_stratixiv_arch_timing.blif', reward_func = 'basic')
